...
class JobConfigJSONProcessorTestCase(unittest.TestCase):
    ...
    def test_generate_job_config_pass_2(self):
        ...
        self.assertEqual(job_config.get_termination_criteria()[0].get_max_duration_sec(), 50)
    ...
    def test_generate_job_config_pass_3(self):
        ...
        self.assertEqual(job_config.get_termination_criteria()[0].get_max_duration_sec(), 50)
        self.assertEqual(job_config.get_termination_criteria()[1].get_max_duration_sec(), 100)
