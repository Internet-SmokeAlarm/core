...
class GetJobControllerTestCase(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        retrieved_job = get_job_controller(project_db_, job_db_, project.get_id(), job.get_id(), auth_context_processor)
    ...
    def test_fail_not_authorized_1(self):
        ...
        auth_context_processor = AuthContextProcessor(auth_json)
        self.assertRaises(RequestForbiddenException, get_job_controller, project_db_, job_db_, project.get_id(), job.get_id(), auth_context_processor)
