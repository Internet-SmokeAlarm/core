...
class GroupOperationsTestCase(unittest.TestCase):
    ...
    def test_update_job_path_pass(self):
        ...
        self.assertEqual(updated_group.get_current_job_ids(), [])
        self.assertTrue(updated_group.contains_job(job.get_id()))
    ...
    def test_update_job_path_pass_2(self):
        ...
        job_builder_2.set_parent_group_id("test_id")
        ...
        self.assertEqual(updated_group.get_current_job_ids(), [job_2.get_id()])
        ...
        self.assertTrue(updated_group.contains_job(job.get_id()))
        self.assertTrue(updated_group.contains_job(job_2.get_id()))
