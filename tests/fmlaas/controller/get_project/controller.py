...
class GetProjectControllerTestCase(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        project.add_or_update_member("user123", ProjectPrivilegeTypesEnum.ADMIN)
        ...
        project_json = get_project_controller(db, project.get_id(), auth_context_processor)

        self.assertEqual(project_json, {'name': 'test_name', 'ID': 'test_id', 'devices': {}, 'job_paths': [], 'current_job_ids': [], 'members': {'user123': {'permission_level': 10}}, "job_info" : {}, "billing" : {}})
    ...
    def test_not_authorized_1(self):
        ...
        self.assertRaises(RequestForbiddenException, get_project_controller, db, project.get_id(), auth_context_processor)
