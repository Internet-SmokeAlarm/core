...
class GetJobAggregateModelControllerTestCase(unittest.TestCase):
    ...
    def test_pass(self):
        ...
        is_job_complete, presigned_url = get_job_aggregate_model_controller(group_db_,
                                                                                job_db_,
                                                                                group.get_id(),
                                                                                job.get_id(),
    ...
    def test_fail_not_authorized_1(self):
        ...
        auth_context_processor = AuthContextProcessor(auth_json)
        self.assertRaises(RequestForbiddenException, get_job_aggregate_model_controller, group_db_, job_db_, group.get_id(), job.get_id(), auth_context_processor)
