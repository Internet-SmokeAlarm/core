...
class IsDeviceActiveControllerTestCase(unittest.TestCase):
    ...
    def test_fail_not_authorized_device(self):
        ...
        auth_context_processor = AuthContextProcessor(auth_json)
        self.assertRaises(RequestForbiddenException, is_device_active_controller, group_db_, job_db_, group.get_id(), job.get_id(), "12344", auth_context_processor)
    ...
    def test_fail_not_authorized_device_2(self):
        ...
        auth_context_processor = AuthContextProcessor(auth_json)
        self.assertRaises(RequestForbiddenException, is_device_active_controller, group_db_, job_db_, group.get_id(), job.get_id(), "123445", auth_context_processor)
