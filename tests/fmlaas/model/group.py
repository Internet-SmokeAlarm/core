...
class FLGroupTestCase(unittest.TestCase):
    ...
    def test_from_json_pass_2(self):
        ...
        group.create_job_path("34345234123")
        group.add_job_to_path_prev_id("34345234123", "564324234")
        group.add_job_to_path_prev_id("564324234", "6324213123")
        group.create_job_path("12312445123")

        group.add_current_job_id("34345234123")
        group.add_current_job_id("12312445123")
        ...
        self.assertEqual(group.get_job_info(), json_group.get_job_info())
        self.assertEqual(group.get_devices(), json_group.get_devices())
        self.assertEqual(group.get_current_job_ids(), json_group.get_current_job_ids())
        self.assertEqual(group.get_members(), json_group.get_members())

    def test_contains_job_pass(self):
        group = self.build_default_group()

        group.create_job_path("12324512")

        self.assertTrue(group.contains_job("12324512"))

    def test_contains_job_fail(self):
        group = self.build_default_group()

        group.create_job_path("1234414")
        job_id_2 = "i_dont_exist"

        self.assertFalse(group.contains_job(job_id_2))
    ...
    def test_add_current_job_id_pass(self):
        ...
        group.add_current_job_id("4142634852358226")

        self.assertTrue("4142634852358226" in group.get_current_job_ids())

    def test_remove_current_job_id_pass(self):
        group = self.build_default_group()

        group.add_current_job_id("4142634852358226")
        group.add_current_job_id("6768564345")
        group.remove_current_job_id("4142634852358226")

        self.assertFalse("4142634852358226" in group.get_current_job_ids())
        self.assertTrue("6768564345" in group.get_current_job_ids())

    def test_add_job_info_pass(self):
        group = self.build_default_group()

        self.assertFalse("665544343443" in group.get_job_info())

        group._add_job_info("665544343443")

        self.assertTrue("665544343443" in group.get_job_info())

    def test_create_job_path_pass(self):
        group = self.build_default_group()

        self.assertEqual(0, len(group.get_job_paths()))

        group.create_job_path("34345234123")

        self.assertEqual(1, len(group.get_job_paths()))
        self.assertEqual(["34345234123"], group.get_job_paths()[0])
        self.assertTrue("34345234123" in group.get_job_info())
    ...
    def test_create_job_path_fail(self):
        ...
        self.assertEqual(["34345234123", "564324234"], group.get_job_paths()[0])
    ...
    def test_add_job_to_path_prev_id_pass(self):
        ...
        self.assertEqual(["34345234123", "564324234", "6324213123"], group.get_job_paths()[0])
        self.assertEqual(["12312445123"], group.get_job_paths()[1])
        self.assertTrue("34345234123" in group.get_job_info())
        self.assertTrue("564324234" in group.get_job_info())
        self.assertTrue("6324213123" in group.get_job_info())
        self.assertTrue("12312445123" in group.get_job_info())
    ...
    def test_add_job_to_path_prev_id_fail(self):
        ...
        group.create_job_path("34345234123")
        group.add_job_to_path_prev_id("34345234123", "564324234")
        group.add_job_to_path_prev_id("6324213123", "63242131235")

        self.assertEqual(["34345234123", "564324234"], group.get_job_paths()[0])
        self.assertTrue("34345234123" in group.get_job_info())
        self.assertTrue("564324234" in group.get_job_info())
        self.assertFalse("63242131235" in group.get_job_info())
    ...
    def test_get_next_job_in_sequence_pass(self):
        ...
        group.create_job_path("123343412")
        group.add_job_to_path_prev_id("123343412", "23423234")
        group.create_job_path("345234242")
        group.add_job_to_path_prev_id("23423234", "6345234242")
        group.create_job_path("84839222")

        self.assertEqual("6345234242", group.get_next_job_in_sequence("23423234"))
        self.assertEqual(None, group.get_next_job_in_sequence("84839222"))
        self.assertEqual(None, group.get_next_job_in_sequence("6345234242"))
