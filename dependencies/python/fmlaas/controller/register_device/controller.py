...
from ...model import (ApiKeyFactory, ApiKeyTypeEnum, DBObject, DeviceFactory,
                      Project, ProjectPrivilegeTypesEnum)
...
class RegisterDeviceController(AbstractController):
    ...
    def execute_controller(self) -> List[Tuple[str, str]]:
        devices = list()
        for i in range(self._num_devices):
            ...
            devices.append((api_key.id, key_plaintext))
